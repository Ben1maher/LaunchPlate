  ...
  switch (component.type) {
      ...
      return (
        <div className="w-full py-12" style={component.style}>
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12">{component.content.title || 'Key Features'}</h2>
    ...
    case 'feature-list':
      return (
        <div className="w-full py-12" style={component.style}>
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold mb-12">{component.content.title || 'Our Features'}</h2>
            <div className="space-y-6">
              {features.map((feature, index) => (
                <div key={index} className="flex items-start p-4 bg-white rounded-lg border border-gray-100">
    ...
    case 'feature-cards':
      return (
        <div className="w-full py-12" style={component.style}>
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12">{component.content.title || 'Feature Cards'}</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {features.map((feature, index) => (
